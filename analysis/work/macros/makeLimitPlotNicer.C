...
void run(TString inDir, TString outDir, int type){
  ...
  TH2D* h2_exp = new TH2D("h2_exp","h2_exp",990,10,1000,500,1,500);
  TH2D* h2_obs = new TH2D("h2_obs","h2_obs",990,10,1000,500,1,500);
  TH2D* h2_p1s = new TH2D("h2_p1s","h2_p1s",990,10,1000,500,1,500);
  TH2D* h2_n1s = new TH2D("h2_n1s","h2_n1s",990,10,1000,500,1,500);
