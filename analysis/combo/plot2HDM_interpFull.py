...
minZp = 600;
minA0 = 300;
binZp = (maxZp-minZp)/50;
binA0 = (maxA0-minA0)/25;

limitPlot = ROOT.TH2F("lplot","lplot",binZp,minZp,maxZp,binA0,minA0,maxA0)
limitPlotObs = ROOT.TH2F("lplotObs","lplotObs",binZp,minZp,maxZp,binA0,minA0,maxA0)
limitPlotUp = ROOT.TH2F("lplotU","lplotU",binZp,minZp,maxZp,binA0,minA0,maxA0)
limitPlotDown = ROOT.TH2F("lplotDown","lplotDown",binZp,minZp,maxZp,binA0,minA0,maxA0)
limitPlotUp2 = ROOT.TH2F("lplotU2","lplotU2",binZp,minZp,maxZp,binA0,minA0,maxA0)
limitPlotDown2 = ROOT.TH2F("lplotDown2","lplotDown2",binZp,minZp,maxZp,binA0,minA0,maxA0)
...
#leg.AddEntry(limitPlotUp2,"Expected Limit +/- 2\sigma (95% CL)","L")
leg.Draw()
