...
hadd data/25ns_v1-1-0_ReReco_afterSynch_CutBased/GJets.root	data/25ns_v1-1-0_ReReco_afterSynch_CutBased/GJet_Pt-20to40.root	data/25ns_v1-1-0_ReReco_afterSynch_CutBased/GJet_Pt-40toInf.root 
hadd data/25ns_v1-1-0_ReReco_afterSynch_CutBased/QCD.root		data/25ns_v1-1-0_ReReco_afterSynch_CutBased/QCD_Pt-30to40.root	data/25ns_v1-1-0_ReReco_afterSynch_CutBased/QCD_Pt-30toInf.root	data/25ns_v1-1-0_ReReco_afterSynch_CutBased/QCD_Pt-40toInf.root 
#hadd data/25ns_v1-1-0_ReReco_afterSynch_CutBased/DoubleEG.root	data/25ns_v1-1-0_ReReco_afterSynch_CutBased/DoubleEG_05Oct.root	data/25ns_v1-1-0_ReReco_afterSynch_CutBased/DoubleEG_PromptV4.root 
