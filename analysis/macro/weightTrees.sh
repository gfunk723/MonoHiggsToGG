...
addWeights("data/25ns_v80X_v0/DoubleEG.root", $lumi);
addWeights("data/25ns_v80X_v0/DiPhoton.root", $lumi);
addWeights("data/25ns_v80X_v0/GluGluHToGG.root", $lumi);

addWeights("data/25ns_v80X_v0/2HDM_mZP600_mA0300.root", $lumi);
addWeights("data/25ns_v80X_v0/2HDM_mZP800_mA0300.root", $lumi);
addWeights("data/25ns_v80X_v0/2HDM_mZP1000_mA0300.root", $lumi);
addWeights("data/25ns_v80X_v0/2HDM_mZP1200_mA0300.root", $lumi);
addWeights("data/25ns_v80X_v0/2HDM_mZP1400_mA0300.root", $lumi);
addWeights("data/25ns_v80X_v0/2HDM_mZP1700_mA0300.root", $lumi);
addWeights("data/25ns_v80X_v0/2HDM_mZP2000_mA0300.root", $lumi);
addWeights("data/25ns_v80X_v0/2HDM_mZP2500_mA0300.root", $lumi);
